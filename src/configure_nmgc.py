...
BEGIN_MARK = "@nmgc_begin"
END_MARK = "@nmgc_end"

NMGC_PATH = os.path.dirname(os.path.realpath(sys.argv[0]))

NMGC_ADDON = """# %s DO NOT EDIT !
#########################################
...
source $nmgc/.nmgc_profile

#########################################
# %s DO NOT EDIT !""" % (BEGIN_MARK, NMGC_PATH, END_MARK)
