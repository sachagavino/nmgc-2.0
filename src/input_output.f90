...
use global_variables
  ...
  write(10,'(a,i0,a)') 'height_h2formation = ', height_h2formation, ' ! Spatial point index at and above which B14s method is used. &
                      &0: B14 not used. -1: B14 applied to all spatial points.'
